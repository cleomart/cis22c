...
public class SList {
	...
	private int size;
	private SListNode tail; //a node that will keep track where the tail is pointing to
	...
	public void insertEnd(Object obj) {
		...
		/** Revised: if head is null, head and tail point to the new node
		 *  else tail.next points to the new node, 
		 *  then tail points to the new node inserted.
		**/
		if (head == null) {
	...
	public static void main (String[] args) {
		...
		//insert int 6 at the front of the list
		numList.insertFront(new Integer(6));
		//insert int 9 at the end of the list
		numList.insertEnd(new Integer(9));
		//insert int 12 at the end of the list
		numList.insertEnd(new Integer(12));
		
		//prints out the resulting list
		System.out.print(numList.toString());

		//insert int 3 at the front of the list
		numList.insertFront(new Integer(3));
		//insert int 15 at the end of the list
		numList.insertEnd(new Integer(15));
